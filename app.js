...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Marc Paquet')
.pauseFor(300)
.typeString('<strong>, Développeur Javascript</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #27ae60;"> CSS</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #026e00;"> Node js</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: #DF4742;"> Angular</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: #fcdc00;"> JavaScript</span> !')
.start()
